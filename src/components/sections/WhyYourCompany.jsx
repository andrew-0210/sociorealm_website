  ...
  return (
    <section className="h-full bg-[#000000] px-[1.25rem] py-[6.25rem] text-[#fff]">
      <div className="mx-auto flex max-w-[1440px] justify-start text-left md:justify-center md:text-center">
        <div className="flex max-w-[590px] flex-col gap-[1.25rem] md:gap-[2rem]">
          <span className="font-serif text-[1.5rem] italic md:text-[2rem]">
            The billion dollar question
          </span>
          <h2 className="text-[1.75rem] leading-[2.25rem] font-extrabold tracking-[-0.5px] text-[#52ffa9] uppercase md:text-[3.5rem] md:leading-[58px]">
