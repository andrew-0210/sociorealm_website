    ...
    <section className="h-full px-[1.25rem] py-[6.25rem]">
      <div className="mx-auto flex max-w-[1440px] items-center">
        <div className="flex max-w-[590px] flex-col items-start gap-[1.25rem] md:gap-[2rem]">
          ...
          <button className="min-w-[250px] cursor-pointer rounded-full border-[2px] border-[#004e39] bg-[#4fbe9f] py-[1rem] text-[1rem] font-extrabold uppercase shadow-[0_6px_0px_rgba(0,78,57,1)] transition-shadow duration-200 ease-in hover:shadow-none md:min-w-[342px] md:text-[1.125rem]">
            Know How
          </button>
        </div>
      </div>
